    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="<?=base_url();?>index.php" class="navbar-brand"><b>Perpus</b>Kami</a>
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><a href="<?=site_url('buku');?>">Daftar Kategori</a></li>
                <li class="divider"></li>
                <li><a href="<?=site_url('buku/add');?>">Tambah Tambah</a></li>
              </ul>
            </li>
      		      <li class="dropdown">
